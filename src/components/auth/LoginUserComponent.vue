  ...
  <div class="login">
    ...
    <div class="center">
      ...
      <input
        type="text"
        autofocus
        placeholder="Type mobile phone or email ... "
      />
      <div class="password">
        ...
        <span class="icon" @click="togglePassword()">
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clip-path="url(#clip0_116_1178)">
              <path
      ...
      <div class="links">
        <span @click="switchToForgotPassword()">Forgot password?</span>
        <span @click="switchToRegsiter()">Register</span>
      </div>
    </div>
...
const togglePassword = () => {
  ...
  password.value = password.value === 'text' ? 'password' : 'text';
};
const switchToRegsiter = () => {
  emit('swtich-to-regsiter', 'register');
};
const switchToForgotPassword = () => {
  emit('forgot-password', 'forgot-password');
};
const login = () => {
  console.log('jimi');
};
...
.center {
  ...
  > *:not(:nth-last-child(2)) {
    margin-bottom: calc(var(--pading-value) * 3);
  }
